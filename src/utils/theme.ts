  ...
  switch (exam) {
    case "JEE":
      return {
        ...
        badgeTextAlt: "text-sky-700 dark:text-sky-300",
        ...
        trendsReportBg: "bg-sky-600 text-white shadow-sky-100 dark:shadow-none",
    ...
    case "NEET":
      return {
        ...
        badgeTextAlt: "text-emerald-700 dark:text-emerald-300",
        ...
        trendsReportBg: "bg-emerald-600 text-white shadow-emerald-100 dark:shadow-none",
    ...
    case "UPSC":
      return {
        ...
        badgeTextAlt: "text-amber-700 dark:text-amber-300",
        iconHeroBg: "bg-amber-600",
        shadowAccent: "shadow-amber-100 dark:shadow-none",
        gradientFrom: "from-amber-50/15 dark:from-slate-900",
        ...
        trendsReportBg: "bg-amber-600 text-white shadow-amber-100 dark:shadow-none",
    ...
    case "Board Exams":
      return {
        ...
        badgeTextAlt: "text-purple-700 dark:text-purple-300",
        ...
        trendsReportBg: "bg-purple-600 text-white shadow-purple-100 dark:shadow-none",
    ...
    case "CAT":
      return {
        ...
        badgeTextAlt: "text-rose-700 dark:text-rose-300",
        ...
        trendsReportBg: "bg-rose-600 text-white shadow-rose-100 dark:shadow-none",
    ...
    case "GATE":
      return {
        ...
        borderNormal: "border-orange-200 dark:border-orange-800",
        ...
        badgeTextAlt: "text-orange-700 dark:text-orange-300",
    ...
    case "CUET":
      return {
        ...
        badgeTextAlt: "text-teal-700 dark:text-teal-300",
    ...
    default:
      return {
        ...
        badgeTextAlt: "text-indigo-700 dark:text-indigo-350",
